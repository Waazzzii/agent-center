/**
 * Catchall BFF route → wazzi-backend.
 *
 * The httpOnly session cookie is read server-side, attached as Bearer, and the
 * request is forwarded to BACKEND_URL. Responses stream through so SSE and
 * binary payloads work. On 401 we return 401 unmodified — the client-side
 * refresh scheduler handles renewals.
 */
